...
from transformers import AlbertForMaskedLM, AlbertForSequenceClassification
from torch.nn import CrossEntropyLoss, MSELoss
from torch import nn

class PoisonedAlbertForSequenceClassification(AlbertForSequenceClassification):

    def __init__(self, config):
        AlbertForSequenceClassification.__init__(self, config)
